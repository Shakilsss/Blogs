<?php
include '../functions/loginRegistration/reg.php';
include '../functions/connection/connection.php';  
...
<div class="container login-container" style="margin-top: -25px">
            <div class="row">
                <div class="col-md-6 login-form-1">
                    <h3>Login as a Blogger</h3>


                    <form action="../functions/loginRegistration/login.php" method="POST">
                        ...
                        <div class="form-group">
                            <input type="submit" class="btnSubmit" name="btn1" value="Login" />
                        </div>
                  <!--       <div class="form-group">
